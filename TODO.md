...
Refactor hardcoded strings into a centralized localization or constants file (e.g., `src/game/data/text.ts` or `src/constants/ui.ts`).
...
- [x] **src/components/map/LocationDetail.tsx**
    ...
    - [x] Default location name: "Wild Area"
...
- [x] **src/game/core/petStats.ts**
    - [x] `createDefaultBonusMaxStats`: Consider defining a `ZERO_STATS` constant.