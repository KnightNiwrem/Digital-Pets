  ...
  objectives: [
    {
      id: "gather_sea_salt",
      type: "collect_item",
      description: "Gather 10 sea salt for the expedition",
      itemId: "sea_salt",
      targetAmount: 10,
      currentAmount: 0,
      completed: false,
    },
    {
      id: "gather_rope",
      type: "collect_item",
      description: "Collect 5 maritime rope for ship operations",
      itemId: "maritime_rope",
      targetAmount: 5,
      currentAmount: 0,
      completed: false,
    },
    {
      id: "gather_compasses",
      type: "collect_item",
      description: "Acquire 3 navigation compasses for deep sea navigation",
      itemId: "navigation_compass",
      targetAmount: 3,
      currentAmount: 0,
      completed: false,
    },
