...
import type { Pet, WorldState, Activity } from "@/types";
      ...
      <CardContent className="space-y-4">
        ...
        {hasActiveActivity && activityProgress.activity && (
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-green-700 mb-3">
              {activityProgress.activity.description}
            </p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-green-800 font-medium">
                  {Math.round(activityProgress.progress)}%
                </span>
              </div>
              ...
              <div className="text-xs text-green-600">
                {activityProgress.timeRemaining} minutes remaining
              </div>
            </div>
          </div>
        )}
            ...
            {availableActivities.length === 0 ? (
              ...
              <div className="space-y-3">
                {availableActivities.map((activity) => {
                  ...
                  const canStart = pet.currentEnergy >= activity.energyCost && 
                                  pet.state !== "sleeping" && 
                                  !disabled;
        ...
        {!hasActiveActivity && !isTravel && availableActivities.some(a => a.energyCost > pet.currentEnergy) && (
          <div className="text-xs text-amber-600 bg-amber-50 p-3 rounded-lg">
            ⚡ Some activities require more energy than your pet currently has. 
            Let them rest or use energy items to restore energy.
          </div>
        )}
        ...
        {pet.state === "sleeping" && !hasActiveActivity && (
          <div className="text-xs text-blue-600 bg-blue-50 p-3 rounded-lg">
            😴 Your pet is sleeping and cannot start new activities. 
            Wake them up to begin exploring!
          </div>
        )}
      </CardContent>
    </Card>
